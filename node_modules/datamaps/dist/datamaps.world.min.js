        ...
        p = {
            ...
            geographyConfig: {
                ...
                popupTemplate: function (a, b) {
                    ...
                    return ['<div class="hoverinfo"> <strong>' + a.properties.name +"<br>" + "</strong>" + '<span style="color:red;">'+window.str + "% Attacks Weekly" +"</span>" + "<br>"+a.properties.name1+"<br>"+"</div>"].join('');
                },
                popupOnHover: !0,
                highlightOnHover: !0,
        ...
        objects: {
            world: {
                ...
                geometries: [{
                    ...
                    properties: {
                        name: "Canada",
                        name1:"Learning always becomes easy when it comes of cyber-security attacks?'"
                    },
                    id: "CA",
                    arcs: [
                        [
                    ...
                    properties: {
                        name: "India",
                        name1:"Learning always becomes easy when it of cyber-security attacks?'"
